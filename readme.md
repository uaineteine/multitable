...
![py version](https://img.shields.io/badge/python-3.10+-blue) ![Version 1.0.5.1](https://img.shields.io/badge/version-1.0.5.1-brightgreen)  [![Lint Check](https://github.com/uaineteine/multitable/actions/workflows/lint_check.yaml/badge.svg)](https://github.com/uaineteine/multitable/actions/workflows/lint_check.yaml) [![Dup Checks](https://github.com/uaineteine/multitable/actions/workflows/dup_checks.yaml/badge.svg)](https://github.com/uaineteine/multitable/actions/workflows/dup_checks.yaml) [![Package](https://github.com/uaineteine/multitable/actions/workflows/package.yaml/badge.svg)](https://github.com/uaineteine/multitable/actions/workflows/package.yaml) [![Unit Tests](https://github.com/uaineteine/multitable/actions/workflows/unit_tests.yaml/badge.svg)](https://github.com/uaineteine/multitable/actions/workflows/unit_tests.yaml)

This program provides a data loading framework for working with tables (DataFrames) in PySpark, Pandas, or Polars. 
