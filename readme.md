...
![py version](https://img.shields.io/badge/python-3.10+-blue) ![Version 1.0.3](https://img.shields.io/badge/version-1.0.3-brightgreen)
...
**Note:** The naming functionality (Tablename, Colname, ColList, NamedList) has been split into a separate `naming-standards` package (v1.0.3).
```
